...
PackName = 'data6.dat'
#ExpectHeader = None
ExpectHeader = bytes.fromhex('AC BF 54 63 AA 01 6E 32') #在此处填写原包开头第0x10~0x17字节，不为空时会自动匹配配置 #bytes do offstet 0x10~07
#GameType = 'Kajiri Kamui Kagura Akebono no Hikari' #仅在ExpectHeader无效时使用 #nome do jogo no header
IfEncrypt = True
